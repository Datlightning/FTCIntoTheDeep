...
public class RobotConstants {
    ...
    public static double wrist_folded = 0.9, wrist_extended=0, floor_pickup_position = 0.56, specimen_deliver = 0.8;//update the 0 and 90 degrees as well.
    ...
    public static String left_servo = "left_servo";//ehub 3
    public static String right_servo = "right_servo";//ehub 1

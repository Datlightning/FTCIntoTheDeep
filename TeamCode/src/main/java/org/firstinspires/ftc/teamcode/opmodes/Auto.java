...
//        }
        ...
        switch(position){
            case RED_SAMPLE:
                ...
                pickupSecond = mecanumDrive.trajectorySequenceBuilder(deliverSample.end())
                        ...
                        .addTemporalMarker(() -> intake.moveWrist(0.8))
                        .setReversed(true)
                        .UNSTABLE_addTemporalMarkerOffset(1.2, () -> intake.moveArm(1420 + intake.getOffset()))
                        .splineToLinearHeading(new Pose2d(-51.5,-51.5, Math.toRadians(45)), Math.toRadians(225))
                        .setReversed(false)
                        .build();
        ...
        while(!isStopRequested() && opModeIsActive()){
            past_slide_current = slide_current;
            slide_current = intake.slides.getCurrent();
            previousGamepad1.copy(currentGamepad1);
            currentGamepad1.copy(gamepad1);
            ...
            switch(auto_position){
                ...
                case 14:
                    ...
                    if(intake.slides.getCurrentPosition() > 1000){
                        intake.moveArm(1500 + intake.getOffset());
                    }

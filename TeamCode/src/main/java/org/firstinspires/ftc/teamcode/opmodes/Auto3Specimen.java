...
public class Auto3Specimen extends NGAutoOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder scoreFirstSpecimenPath = drive.actionBuilder(beginPose)
                ...
                .splineToSplineHeading(new Pose2d(-2, -33.1, Math.toRadians(270)), Math.toRadians(90), new TranslationalVelConstraint(50), new ProfileAccelConstraint(-20,40));
        TrajectoryActionBuilder clearSamples = scoreFirstSpecimenPath.endTrajectory().fresh()
                ...
                .splineToSplineHeading(new Pose2d(38, -14, Math.toRadians(0)), Math.toRadians(270), new TranslationalVelConstraint(50), new ProfileAccelConstraint(-7,30))
                .splineToConstantHeading(new Vector2d(38, -50), Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(38, -12), 0)
                .splineToConstantHeading(new Vector2d(50, -16), Math.toRadians(270), new TranslationalVelConstraint(50), new ProfileAccelConstraint(-7,30))
...
//                .splineToConstantHeading(new Vector2d(62, -46), Math.toRadians(270), new TranslationalVelConstraint(60))
        ...
        TrajectoryActionBuilder moveForward1 = clearSamples.endTrajectory().fresh()
                .lineToX(32, new TranslationalVelConstraint(50), new ProfileAccelConstraint(-10,30));
        ...
        TrajectoryActionBuilder pickThirdSpecimenPath = scoreSecondSpecimenPath.endTrajectory().fresh()
                ...
                .splineToSplineHeading(new Pose2d(25, -58, Math.toRadians(0)), Math.toRadians(0), new TranslationalVelConstraint(50), new ProfileAccelConstraint(-15,40));
...
//        if(SPECIMEN_COUNT == 4){
            auto = new SequentialAction(
                    ...
                    new ParallelAction(
                        clearSampleAction,
                        new SequentialAction(
                                openClawAfterDistance(7.25, rear_distance),
